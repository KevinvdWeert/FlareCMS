    ...
    <div className="settings-page-shell">
      <div className="admin-section-header">
        <div className="settings-page-header-main">
          <div className="settings-page-kicker">Settings • SEO</div>
          <h1 className="settings-page-title">SEO Settings</h1>
          <p className="settings-page-description">
            Customize your search foundation. Manage title templates, canonical strategy, and social
            preview defaults across all public pages.
          </p>
        </div>
      ...
      <div className="settings-card">
        ...
        <p className="settings-muted-note" style={{ marginTop: 12, marginBottom: 0 }}>
